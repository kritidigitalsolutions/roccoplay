      ...
      if (response != null && response.success) {
        ...
        Future.delayed(const Duration(milliseconds: 100), () {
          if (isNew || isProfileIncomplete) {
            ...
            FirebaseAnalyticsService.instance.register();
            Get.offAll(() => CreateProfilePage(phone: phoneNumber));
          } else {
            MetaEventService.instance.login();
            FirebaseAnalyticsService.instance.login();
                        ...
                        () => TextButton(
                          ...
                          child: Text(
                            otpController.isResendButtonDisabled.value
                                ...
                                : 'Resend OTP',
                            style: TextStyle(
                              color: otpController.isResendButtonDisabled.value ? Colors.grey : AppColors.buttonColor,
                            ),
                          ),
                        ),
                      ),
