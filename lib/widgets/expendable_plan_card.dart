                ...
                children: [
                  ...
                  if (widget.features.isNotEmpty)
                    Row(
                      ...
                      children: [
                        if (widget.features.isNotEmpty)
                          featureBox(Icons.lock, widget.features[0]),
                        if (widget.features.length > 1)
                          featureBox(Icons.block, widget.features[1]),
                        if (widget.features.length > 2)
                          featureBox(Icons.sd, widget.features[2]),
                      ],
                    ),
                  ...
                  if (widget.features.length > 3)
                    Column(
                      children: List.generate(widget.features.length - 3, (
                        index,
                      ) {
